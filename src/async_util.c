...
void ljack_async_lock_init(Lock* lock)
{
...
void ljack_async_lock_destruct(Lock* lock)
{
#if defined(LJACK_ASYNC_USE_PTHREAD)
...
void ljack_async_mutex_init(Mutex* mutex)
{
#if defined(LJACK_ASYNC_USE_PTHREAD)
...
void ljack_async_mutex_destruct(Mutex* mutex)
{
#if defined(LJACK_ASYNC_USE_PTHREAD)
...
void ljack_async_mutex_wait(Mutex* mutex) 
{
#if defined(LJACK_ASYNC_USE_PTHREAD)
...
bool ljack_async_mutex_wait_millis(Mutex* mutex, int timeoutMillis)
{
#if defined(LJACK_ASYNC_USE_PTHREAD)
